...
def _parse_args():
    ...
    parser.add_argument('-s', '--steps', help='number of pooling and upsampling steps.', default=2, type=int)
    parser.add_argument('-l', '--layers', help='number of convolutional layers per step', default=2, type=int)
    parser.add_argument('-k', '--kernel', help='kernel size. can be list of length steps.', default=4, nargs='*', type=int)
    parser.add_argument('-f', '--filters', help='number of filters in first step.', default=64, type=int)
